...
public class EnemyManager {
    ...
    private void loadEnemyImgs() {
        ...
        for(int i = 0; i<3;i++){
            enemyImages[i] = LoadSave.getSpriteAtlas().getSubimage(i *32,32,32,32);
        }
    }
    ...
    private void updateEnemyMove(Enemy e) {
        ...
        }else if(isAtEnd(e)){//dusman sona ulastiginda canimizi eksiltir ve yok olur
            e.kill();
    ...
    public void addEnemy(int enemyType){
        ...
        String dusmanAdi = Constants.Enemies.GetEnemyName(enemyType);
        String logMesaji = "Dusman: '" + dusmanAdi + "-ID: " + id +" "+ Constants.Enemies.GetStartHealth(enemyType) + "/" + Constants.Enemies.GetStartHealth(enemyType) + " haritaya girdi.";
        LoadSave.WriteToLog(logMesaji);
    }
